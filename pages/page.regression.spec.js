...
describe('General scenarios', () => {
  ...
  it('Page should have title and graph from page and not from widget configuration', () => {
    visitPage('uiTestWidgetsPageConfigOverride', 'getUiTestWidgetsPageConfigOverride');
    cy.contains('Chartone');
