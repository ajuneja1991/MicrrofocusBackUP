...
describe('Tag Rest Service V1 Test', () => {
  let nullRefTags = [];
...
describe('Tags permissions V1 test', () => {
  let roles = [];
  let pages = [];
  let nullRefTags = [];
...
describe('Tags group permissions V1 test', () => {
  let roles = [];
  let pages = [];
  let nullRefTags = [];
  ...
  it('With Specific group permission, creating a authorized rbac tag referring to a page, should be successful', done => {
    const myRole = {
      ...
      permission: [{
        ...
        operation_key: 'AssignPages',
        // eslint-disable-next-line camelcase
        resource_key: 'default_action<>Group-grp3'
      }]
    };
    const page = { ...mockData.page, id: 'PageToTestRbacInTags', title: 'PageToTestRbacInTags', tags: []};
    const tag = {
