...
const apiPageWithComponents = '/rest/v1/pagesWithComponents/';
const apiMetaContext = '/rest/v1/pages/metadata';
const apiToc = '/rest/v1/pages/toc';
const apiTag = '/rest/v1/tag/';
const apiTagVal = '/rest/v1/tagVal/';
...
describe('Pages Rest Service Test - V1', () => {
  it('Login admin', done => {
...
describe('Page crud operation - V1', () => {
  it('Login admin', done => {
    shared.login(request, loginURL, adminLogin, adminPasswd, done);
  });
...
describe('Limit pages by tags operations - V1', () => {
...
describe('Admin User Limit pages with tags - V1', () => {
  it('Login admin', done => {
...
describe('Limit pages by tags when user re-authenticates - V1', () => {
  const context = [{
    type: 'host'
  }];
  let originalAppConfig;
...
describe('Pages can enabled with licenses via page tagging - V1', () => {
  ...
  it('License based page should not be retrieved when license is not installed', done => {
    const mockPage = {
      ...mockData.page,
  ...
  it('License based page should not be retrieved when license is not installed v1', done => {
    const mockPage = {
      ...mockData.page,
