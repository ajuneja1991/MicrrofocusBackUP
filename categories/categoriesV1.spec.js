...
describe('Categories API Test - V1', () => {
  const
    apiBase = '/rest/v1/categories',
    apiBaseMenuCategories = `/rest/v1/categories?scope=${constants.MENU_SCOPE}`,
    apiBaseCategories = `/rest/v1/categories?scope=${constants.PERMISSION_SCOPE}`,
